...
const char *gengetopt_args_info_help[] = {
  ...
  "  -d, --database=RELATION  The database that contains the relation",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->relation_help = gengetopt_args_info_help[2] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->relation_arg));
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->relation_given)
    {
      fprintf (stderr, "%s: '--relation' ('-r') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVr:d:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'r':	/* The relation that should be analyzed.  */
          ...
          if (update_arg( (void *)&(args_info->relation_arg), 
               &(args_info->relation_orig), &(args_info->relation_given),
              &(local_args_info.relation_given), optarg, 0, 0, ARG_STRING,
